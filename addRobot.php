        ...
        <div class="row">
            <div class="col-5">
                ...
                <ul id="menu">
                    ...
                    <li><a href="robot.php">客服機器人管理</a></li>
            ...
            <div class="col-19">
                <div class="main">
                    <div id="breadcrumb">
                        ...
                        <a href="robot.php" id="a">客服機器人Q&A清單</a>
                        <i class="material-icons">keyboard_arrow_right</i>
                    ...
                    <form action="robotChange.php" id="new">
                        <div class="editArea">
                            <div class="row">
                                ...
                                <div class="col-20">
                                    <input type="text" value="" name="defaultQ" maxlength="15" id="defaultQ">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-20">
                                    <textarea name="ans1" id="ans1" cols="100" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-20">
                                    <textarea name="ans2" id="ans2" cols="100" rows="5"
                                        placeholder="若無則毋須填寫"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-20">
                                    <textarea name="ans3" id="ans3" cols="100" rows="5"
                                        placeholder="若無則毋須填寫"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-20">
                                    <textarea name="ans4" id="ans4" cols="100" rows="5"
                                        placeholder="若無則毋須填寫"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                    <label for="qsOrd">於對話框排列順序</label>
                                </div>
                                <div class="col-20">
                                    <select name="qsOrd" id="qsOrd">
